...
// const weekDaysEen = ["mon", "tue", "wed", "thu", "fri", "sat", "sun"];
// const weekDaysRu = ["понедельник", "вторник", "среда", "четверг", "пятница", "суббота", "воскресенье"];

// const weekEnRu = {};

// if (weekDaysEen.length === weekDaysRu.length) {
//     for (let i = 0; i < weekDaysEen.length; i++) {
//         weekEnRu[weekDaysEen[i]] = weekDaysRu[i];
//     };
//     console.log(weekEnRu);
// } else console.log('Не хватает дней');
